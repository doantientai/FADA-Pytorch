...
parser.add_argument('--n_target_samples', type=int, default=5)
...
train_dataloader = dataloader.svhn_dataloader(batch_size=opt['batch_size'], train=True)
test_dataloader = dataloader.svhn_dataloader(batch_size=opt['batch_size'], train=False)
...
test_dataloader = dataloader.mnist_dataloader(train=False, batch_size=opt['batch_size'])
